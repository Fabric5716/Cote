// profil.js - Upload photo, validation, auto-disparition des alertes
document.addEventListener('DOMContentLoaded', function() {
    // Gestion upload photo (clic sur l'avatar)
    ...
    // Détection modifications sur le formulaire de coordonnées
