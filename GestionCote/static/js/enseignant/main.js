/**
 * MAIN.JS - Adapté du modèle PHP (percepteur) pour enseignant
 * Gestion du thème, sidebar, dropdowns, date/time, animations
 */
(function() {
    'use strict';
    ...
    function initSidebarPremium() {
        ...
        const hamburger = document.getElementById('sidebarToggle'); // attention : l'id est dans topbar
        ...
        // Fermeture auto sur mobile après clic sur un lien
